...
% produced the Potts models pairwise interactions $J$ values and the propensities $h$.
...
%In the AlphaFold paper \cite{alphafold}, the authors decided (and so did we) 
